...
const char* serverName = "https://demo.thingsboard.io/api/v1/testdesd23/telemetry"; // Server URL
long humidity_between_1_to_100;
...
void loop() 
{
   ...
   */
   ...
   sensor_data["Humidity"] = humidity_between_1_to_100;
