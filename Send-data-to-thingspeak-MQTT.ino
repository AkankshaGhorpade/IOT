...
const char* clientID = "NyUHLBIDEiQIGDYOKxQPPBk";                   // client-id --> replace it in case willing to connect with same broker

const char* mqttusername = "NyUHLBIDEiQIGDYOKxQPPBk";

const char* mqttpassword = "/JoTA3cOPU9j3pv9RwvbdmHe";
//channels/<channelID>/publish/fields/field<fieldnumber>
const char* field1mqtttopic = "channels/2384508/publish/fields/field1"; 
const char* field2mqtttopic = "channels/2384508/publish/fields/field2";
const char* field3mqtttopic = "channels/2384508/publish/fields/field3";
float field1, field2;
int field3;
...
void loop() {
  ...
  { 
    ...
    field1 = random(-16,56); // field1 is represented as sensor parameter say temperature
    //delay(500);
    field2 = random(0,100);  // humidity
    //delay(500);
    field3 = random(0,350);         // aqi
    //delay(500);
